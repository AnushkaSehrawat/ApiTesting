...
namespace HotelManagementSystem.Tests
{
    ...
    public class AddHotelSteps
    {
        ...
        [Then(@"the added hotel enteries with all '(.*)'should be present in the database\.")]
        public void ThenTheAddedHotelEnteriesWithAllShouldBePresentInTheDatabase_(int id)
        {
            //ScenarioContext.Current.Pending();
